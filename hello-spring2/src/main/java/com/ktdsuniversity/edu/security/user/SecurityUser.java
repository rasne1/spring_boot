...
public class SecurityUser implements UserDetails{
	...
	/*
	 * userDetails 인터페이스로 사용자의 세부 내용을 알 수 없기 떄문에
	...
	public Collection<? extends GrantedAuthority> getAuthorities() {
		...
		// Spring Security가 ROLE 과 ACTION을 구분하는 방법.
		// 권한 ==> prefix == 'ROLE_RL-20260414-000001'
